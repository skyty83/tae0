...
function buildHtml() {
	...
	let bodyHeader = '<div id="header"><h1><img src="https://staging-tbms.talentbank.co.kr/img/talent-logo.e046c60c.svg" width="200"></h1><div class="expand-control"><button type="button" class="toggle-expand">모두 접기</button></div></div>';
